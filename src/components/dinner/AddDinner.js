...
import '../breakfast/AddBreakfast.css';
...
const AddDinner = (props) => {
    ...
    const [weight, setWeight] = useState('')
          ...
          const addFood = () => {
              axios.post('api/dinner', {name:foodName, calories: calories, protein:protein, carbs: carbs, fat: fat, weight: weight})
                .then(res => res.data)
                .then(props.history.push('/dinner'))
